...
b.css({width:a.width+"px",height:a.height+"px",position:"absolute",overflow:"hidden"});g.SetEnlarger(a.label,{width:a.width,height:a.height,zoomperc:a.zoomperc,scale:1+a.zoomperc/100});g.RegisterOnMove(a.label,c.Move)}}}}angular.module("npImageWidgets.Enlarger",["npImageServices"]).directive({npImage:d,npImageEnlarge:k});d.$inject=["$log","npImageSvc"];k.$inject=["$log","npImageSvc"]})();(function(){angular.module("npImageWidgets",["npImageWidgets.Enlarger"])})();
